...
unsafe impl GlobalAlloc for ArenaAllocator {
    ...
    unsafe fn dealloc(&self, ptr: *mut u8, _layout: Layout) {
        unsafe {
            ...
            // if size is bigger than default arena, it must've been large arena allocation
    ...
    unsafe fn realloc(&self, ptr: *mut u8, layout: Layout, new_size: usize) -> *mut u8 {
        unsafe {
            ...
            // case 1: current block already large enough -> optionally shrink by splitting tail.
            if needed_total < old_total {
            ...
            // case 2: need to grow. Try to merge with next free block
            {
                let mut state = STATE.lock();
